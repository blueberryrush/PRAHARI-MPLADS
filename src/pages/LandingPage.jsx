...
export default function LandingPage() {
  ...
  const cards = [
    ...
    { icon: SearchCheck, title: hi ? 'जांच केंद्र' : 'Investigation Centre', text: hi ? 'साक्ष्य देखें और सत्यापित करें' : 'Investigate evidence and verify', to: '/login?role=investigator' },
  ...
  return <div className="landing">
    <header className="landing-nav">
      <div className="brand-lockup"><div className="brand-mark">P</div><div><div className="brand-name">PRAHARI</div><div className="brand-sub">{hi ? 'समग्र जवाबदेही और वास्तविक समय इंटेलिजेंस के लिए भविष्यसूचक जोखिम विश्लेषण' : 'Predictive Risk Analytics for Holistic Accountability & Real-time Intelligence'}</div></div></div>
    ...
    <main>
      ...
      <section className="access-section">
        <div className="section-intro"><span className="eyebrow">{hi ? 'एक मंच · तीन दृष्टिकोण' : 'ONE PLATFORM · THREE VIEWS'}</span><h2>{hi ? 'आप PRAHARI का उपयोग कैसे करना चाहते हैं?' : 'How would you like to access PRAHARI?'}</h2><p>{hi ? 'एक ही intelligence layer, भूमिका के अनुसार अलग अनुभव।' : 'One intelligence layer, tailored to the job at hand.'}</p></div>
